...
API_HASH = environ.get('API_HASH', '2144747408936a7dfc36c1efeea2c7f3e')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1620396764').split()] # For Multiple Id Use One Space Between Each.
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002350804081')).split()]  # For Multiple Id Use One Space Between Each.
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/KanFlixOwnerBot')
